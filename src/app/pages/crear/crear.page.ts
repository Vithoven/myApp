...
export class CrearPage implements OnInit {
  ...
  // Validador personalizado para correos
  static emailDomainValidator(control: AbstractControl): ValidationErrors | null {
    const email = control.value;
    if (email && !email.endsWith('@cosl.cl') && !email.endsWith('@alumnoscosl.cl')) {
  ...
  createUserForm = new FormGroup({
    ...
    uemail: new FormControl('', [Validators.required, Validators.email, CrearPage.emailDomainValidator]),
